...
urlpatterns = [
    ...
    path("reports/profit-loss/export.xlsx", profit_loss_export_xlsx, name="profit_loss_export_xlsx"),
    path("reports/balance-sheet/", balance_sheet_report, name="balance_sheet_report"),
    path("reports/balance-sheet/content/", balance_sheet_content, name="balance_sheet_content"),
    path("reports/cashflow/", cashflow_report, name="cashflow_report"),
    path("reports/cashflow/content/", cashflow_content, name="cashflow_content"),
    ...
    path("categories/options/", category_options, name="category_options"),
